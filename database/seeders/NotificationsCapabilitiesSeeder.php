...
use App\Modules\Notifications\Interfaces\MCP\NotificationsCapabilities;
use Illuminate\Database\Seeder;

/**
 * Registers the Notifications module's capabilities into the Capability
 ...
 * for why this cannot safely live in NotificationsServiceProvider::boot()
 ...
 */
class NotificationsCapabilitiesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach (NotificationsCapabilities::definitions() as $definition) {
            try {
