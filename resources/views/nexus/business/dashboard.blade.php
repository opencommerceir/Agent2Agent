        ...
        <x-nexus-panel>
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('nexus.catalog.index') }}" class="rounded-md border border-nexus-purple/40 px-3 py-1.5 text-sm text-nexus-purple hover:bg-nexus-purple/10">
                        {{ t('messages.nexus.catalog.title') }}
                    </a>
                    ...
                    <a href="{{ route('nexus.developer.docs.index') }}" class="rounded-md border border-nexus-purple/40 px-3 py-1.5 text-sm text-nexus-purple hover:bg-nexus-purple/10">
                        {{ t('messages.nexus.developer.docs.title') }}
                    </a>
                    <a href="{{ route('nexus.developer.integrations.index') }}" class="rounded-md border border-nexus-purple/40 px-3 py-1.5 text-sm text-nexus-purple hover:bg-nexus-purple/10">
                        {{ t('messages.nexus.developer.integrations.title') }}
                    </a>
                    <a href="{{ route('nexus.developer.agent-marketplace.index') }}" class="rounded-md border border-nexus-purple/40 px-3 py-1.5 text-sm text-nexus-purple hover:bg-nexus-purple/10">
                        {{ t('messages.nexus.developer.agent_marketplace.title') }}
                    </a>
