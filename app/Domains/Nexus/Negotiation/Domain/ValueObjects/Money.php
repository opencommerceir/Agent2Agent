...
/**
 * Negotiation's own copy — each module in this codebase owns its own
 * Money VO rather than sharing one (see Catalog's own copy's docblock),
 * since a shared kernel type would itself be a direct inter-module
 * dependency. Same shape as every other copy: amount stored in the
 * smallest currency unit to avoid float rounding errors.
 */
final class Money
{
