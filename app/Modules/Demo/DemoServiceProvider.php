...
class DemoServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        $registry->register('demo.tools.echo', fn (array $input) => $this->app->make(EchoAction::class)->execute($input));
        $registry->register('demo.tools.time', fn (array $input) => $this->app->make(GetCurrentTimeAction::class)->execute($input));
        $registry->register('demo.tools.calculator', fn (array $input) => $this->app->make(CalculateAction::class)->execute($input));
    }
}
